...
<div class="row">
    <div class="col-md-5 mt-3 " style="background-color: rgba(47, 79, 79, 0.8); border-radius: 10px">
    ...
    <div class="col-md-5 mt-3 ml-md-auto " style="background-color: rgba(47, 79, 79, 0.8); border-radius: 10px">
